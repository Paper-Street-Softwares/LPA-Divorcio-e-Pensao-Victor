...
function HeroTemplateNovo({
  ...
  return (
    ...
    >
      <section className="relative w-full pt-[110px] phone2:pt-[130px] pb-[30px] tablet1:pb-[64px] desktop1:pb-[96px] phone3:pt-[170px] tablet1:pt-[180px] desktop1:pt-[180px] flex items-center justify-center overflow-hidden font-mainFont">
